...
def get_epa_data(es, start_date=None,
                 end_date=None):
    # pylint: disable=duplicate-code
    """
    Get the avg air quality data from the Elasticsearch server.
            ...
            "aggs": {
                ...
                "daily_particle_val": {
                    ...
                    "aggs": {
                        "avg_value": {
                            "avg": {
                                "field": "siteHealthAdvices.averageValue"
                            }
                        }
                    }
                }
...
def main():
    ...
    try:
        es = setup_connection()
        data = get_epa_data(es, start_date, end_date)
        json_data = {
            "hits": data['hits']['hits'],
